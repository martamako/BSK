...
class Application:
    ...
    def create_menu(self):
        ...
        self.decrypting_btn = Button(self.options_frame, text="Encrypting", font=("Bold", 15), fg="#158aff", bd=0,
                                     bg="#c3c3c3", command=self.decrypting_page)
        self.decrypting_btn.place(x=10, y=250)
    ...
    def signing_page(self):
        ...
        encrypting_btn = Button(signing_frame, text="Encrypting", font=("Bold", 12), fg="#158aff", bd=0,
                                bg="#c3c3c3", command=self.encrypting_file)
        encrypting_btn.pack(pady=10)
    ...
    def encrypting_page(self):
        ...
        encrypting_btn = Button(encrypting_page, text="Encrypting", font=("Bold", 12), fg="#158aff", bd=0,
                                bg="#c3c3c3", command=self.encrypting_file)
        encrypting_btn.pack(pady=10)
